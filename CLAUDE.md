...
2. **State Trajectory** (`/state-trajectory`) — Slope chart + sortable table, dark cards. Mobile: slope chart margins scale responsively (150→110→70px) with smaller label fonts (9px); legend buttons and table cells use tighter padding; min SVG width lowered to 320px to prevent horizontal scroll on phones.
